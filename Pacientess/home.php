...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                   ...
                   <li class="nav-item dropdown">
                       ...
                       <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#" id="menuAlumno">Pacientes</a></li>
    ...
    <div class="container">
        ...
        <div id="divPrincipal" style="text-align: center;">
            ...
            <img src="images/TESSFP.png" width="600px" height="300px" style="border-radius: 20%;">
        </div>
         <!--Termina Pag de principal-->
    </div>
    <!--Termina div de cuerpo-->
    <!--Inicia div de Formulario-->
            <div class="col-9" id="mostrarReportes">
            </div>

            <hr><br>
            <hr><br>
            <div class="col-11" id="mostrar">
            </div>
             <div class="col-11" id="mostrarReporte">
            </div>
